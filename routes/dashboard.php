...
Route::middleware(['auth', 'verified', 'auto.permission'])->prefix('dashboard')->name('menu.')->group(function () {
    // Menu Trash, Export, Import & Bulk Operations (MUST be before resource routes)
    ...
    // Category Trash, Export, Import & Bulk Operations (MUST be before resource routes)
    ...
    // Menu Type Trash, Export, Import & Bulk Operations (MUST be before resource routes)
